    ...
    return (
        <>
                ...
                <div className='flex-none shadow-4xl  h-screen'>
                    ...
                    <h1 className='p-5 font-bold text-4xl inline-block'><span className='text-[#880ED4]'>Admin </span>Panel</h1>
                    ...
                    <div className='h-fit'>
                        ...
                        <Link href="/admin/hostReq">
                        {(!props.orders)?(
                        <p className="font-bold text-2xl p-5 ">Host Requests</p>
                        ):(
                            <p className="font-bold text-2xl p-5 bg-gray-100">Host Requests</p>
                            )}
                        </Link>
                        ...
                        <button className=" ml-5 mt-5 transition duration-300 ease-in-out bg-[#880ED4]  text-black-700 font-semibold  hover:text-white py-1 px-1 border border-none hover:border-transparent shadow-lg mr-10"
                ...
                {(!props.option) && (user) &&(
                <div className='grow bg-[#880ED4] h-screen'>
