        ...
        <div className='grow bg-[#DC143C]'>
            ...
            <div className='flex align-center justify-center'>
                <div className='flex flex-col mt-10 gap-5 bg-white w-1/2 p-5'>
                    ...
                    <button className="mt-5 transition duration-300 ease-in-out bg-black  text-white font-semibold  hover:text-[#DC143C] py-1 px-1 border border-none hover:border-transparent shadow-lg "
                        >SUBMIT</button>
                </div>
            </div>
        </div>
